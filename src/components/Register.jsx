    ...
    <section className='h-screen flex items-center justify-center'>
          <div className='max-w-sm border shadow-lg bg-white mx-auto p-8'>
            ...
            <form onSubmit={handleRegister} className='space-y-5 max-w-sm mx-auto pt-8'>
                <input onChange={(e) => setUsername(e.target.value)} type='text' name='username' id='username' placeholder='Username' required className='w-full bg-green-100 focus:outline-none px-5 py-3' />
                ...
                <p className='my-5 italic text-sm text-center'>Already have an account.Please <Link to={'/login'} className='text-red-400 underline px-1'> Login</Link> </p>
