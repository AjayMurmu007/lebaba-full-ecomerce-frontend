...
const UserOrders = () => {
    ...
    if (error) return <div className="text-center text-gray-400 mt-10">No order found!</div>
                    ...
                    <div className="flex flex-wrap items-center md:justify-between justify-center">
                        <div className="w-full md:w-6/12 px-4 mx-auto text-center">
                            <div className="text-sm text-blueGray-500 font-semibold py-1">
                                Made with <a href="#" className="text-blueGray-500 hover:text-gray-800" target="_blank">Ecommerce</a> by <a href="#" className="text-blueGray-500 hover:text-blueGray-800" target="_blank"> Ajay</a>.
                            </div>
                        </div>
                    </div>
                </div>
